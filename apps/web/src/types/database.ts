...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      debts: {
        Row: {
          ...
          tipo: Database["public"]["Enums"]["debt_kind"]
          valor_total: number
          workspace_id: string
        }
        Insert: {
      ...
      recurring: {
        Row: {
          ...
          tipo: Database["public"]["Enums"]["transaction_kind"]
          valor: number
          workspace_id: string
        }
        Insert: {
        ...
        Relationships: [
          {
            foreignKeyName: "recurring_categoria_id_fkey"
          ...
          {
            foreignKeyName: "recurring_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recurring_workspace_id_fkey"
            columns: ["workspace_id"]
            isOneToOne: false
            referencedRelation: "workspaces"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      fn_is_editor: { Args: { p_ws: string }; Returns: boolean }
      fn_is_member: { Args: { p_ws: string }; Returns: boolean }
      fn_is_owner: { Args: { p_ws: string }; Returns: boolean }
    }
    Enums: {
      category_kind: "gasto" | "entrada" | "investimento"
      debt_kind: "receber" | "pagar"
      transaction_kind: "gasto" | "entrada"
